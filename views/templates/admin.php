...
<div>
    <a class="submit" href="index.php?action=showUpdateArticleForm">Ajouter un article</a> | <a class="submit" href="index.php?action=articleStat">Voir les statistiques</a>
<div>